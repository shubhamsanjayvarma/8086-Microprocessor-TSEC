...
export const examples: AssemblyExample[] = [
  {
    ...
    description:
      "Adds two 16-bit registers (AX and BX) and stores the result in memory (data segment).",
...
`,
  },
  {
    ...
    description:
      "Iterates through an array of numbers in the data segment and finds the maximum value.",
...
`,
  },
  {
    ...
    description:
      "Computes the factorial of a number N (e.g., 5! = 120 / 78h) using a simple decremental loop.",
    code: `; Factorial of N
org 100h
...
`,
  },
  {
    ...
    description:
      "Generates the first 8 numbers of the Fibonacci series and stores them sequentially in memory.",
...
`,
  },
  {
    ...
    description:
      "Reads a string from memory, pushes it character-by-character onto the stack, and pops it back to reverse it.",
