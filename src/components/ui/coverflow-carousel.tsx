    ...
    >
      ...
      {showCaption && active?.title && (
        <a
          ...
          rel={active.href ? "noreferrer" : undefined}
        ...
        >
          ...
          {active.subtitle && (
            <p
              ...
              style={{ color: "var(--yj-text-dim)" }}
            >
              {active.subtitle}
            </p>
          )}
          {active.meta && active.meta.length > 0 && (
            <dl className="mt-4 w-full flex justify-center gap-8 text-[12px]">
              {active.meta.map((row) => (
                <div key={row.label} className="flex gap-2">
                  <dt style={{ color: "var(--yj-text-dim)" }}>{row.label}:</dt>
                  <dd
        ...
        <div className="mt-6 flex items-center justify-center gap-2">
          {slides.map((_, index) => (
            <button
              ...
              style={{ backgroundColor: "var(--yj-text-main)" }}
            />
          ))}
        </div>
      )}
